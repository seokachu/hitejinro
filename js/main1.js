...
var menu = $('header nav'),
    headerBg = $('header'),
    menuHeight = menu.outerHeight(), //nav -> 38
    headerHeight = headerBg.outerHeight(), // header -> 109
    SubHeight = 242, // submenu ul -> 242
    //서브메뉴의 높이가 다 다릅니다. 메뉴메뉴의 높이중 가장 긴 요소의 높이로 지정해야, 아니면 직접 높이를 줘도 됩니다.
    ...
    function menuHoverFunc(){
        menu.mouseenter(function(){
            ...
            headerBg.stop().animate({height: headerHeight + SubHeight - 30},duration);
        }).mouseleave(function(){
            $(this).stop().animate({ height : menuHeight });
            headerBg.stop().animate({height: headerHeight});
        });
    }
    ...
    var headerBar = headerBg.find('.header_wrap .header_bar'),
        asideMenu = $('aside'),
